...
var setorizacao_routes_exports = {};
__export(setorizacao_routes_exports, {
  setorizacaoRoutes: () => setorizacaoRoutes
});
module.exports = __toCommonJS(setorizacao_routes_exports);
...
// src/routes/setorizacao.routes.ts
function setorizacaoRoutes(app) {
  return __async(this, null, function* () {
    app.get("/emails", () => {
